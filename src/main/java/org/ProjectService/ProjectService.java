...
public class ProjectService {
    ...
    private static String BASE_URL = "http://127.0.0.1:8080/project/";
    private static ProjectService instance;
    private final org.ProjectService.ProjectServiceInterface projectApi;

    private ProjectService(org.ProjectService.ProjectServiceInterface projectApi) {
    ...
    public static synchronized ProjectService getInstance(String accessToken) {
        if (instance == null) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .build();
            org.ProjectService.ProjectServiceInterface projectApi = retrofit.create(ProjectServiceInterface.class);
